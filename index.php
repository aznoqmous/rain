...
<html>
  ...
  <body>
    <div class="rain-container" data-col="10" data-lg-col="10" data-md-col="3" data-sm-col="2" data-xs-col="1">
    </div>
  </body>
  <script>
    document.addEventListener('DOMContentLoaded', function(){

      let container = document.getElementsByClassName('rain-container')[0];
